...
export const STAGE_COLORS: Record<StageType, { 
  ...
  [StageType.Sauna]: {
    ...
    ringBg: 'stroke-amber-500/20 dark:stroke-amber-400/20',
    bar: 'bg-amber-500 dark:bg-amber-400',
    track: 'bg-amber-500/30 dark:bg-amber-400/30',
    sand: 'fill-amber-500 dark:fill-amber-400',
    glass: 'stroke-amber-500/40 dark:stroke-amber-400/40',
  },
  [StageType.Cold]: {
    bg: 'bg-sky-50 dark:bg-slate-900',
    text: 'text-blue-700 dark:text-blue-400',
    ring: 'stroke-blue-500 dark:stroke-blue-400',
    ringBg: 'stroke-blue-500/20 dark:stroke-blue-400/20',
    bar: 'bg-blue-500 dark:bg-blue-400',
    track: 'bg-blue-500/30 dark:bg-blue-400/30',
    sand: 'fill-blue-500 dark:fill-blue-400',
    glass: 'stroke-blue-500/40 dark:stroke-blue-400/40',
  },
  [StageType.Rest]: {
    bg: 'bg-slate-100 dark:bg-slate-900',
    text: 'text-slate-600 dark:text-slate-300',
    ring: 'stroke-slate-500 dark:stroke-slate-400',
    ringBg: 'stroke-slate-500/20 dark:stroke-slate-400/20',
    bar: 'bg-slate-500 dark:bg-slate-400',
    track: 'bg-slate-500/30 dark:bg-slate-400/30',
    sand: 'fill-slate-500 dark:fill-slate-400',
    glass: 'stroke-slate-500/40 dark:stroke-slate-400/40',
  },
};