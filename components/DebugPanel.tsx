...
export const DebugPanel: React.FC<DebugPanelProps> = ({ session, onExit }) => {
    ...
    return (
        <div className="flex flex-col h-screen bg-slate-950 text-slate-300 p-6 font-mono text-sm">
            <header className="flex justify-between items-center border-b border-slate-800 pb-4 mb-6">
                <div>
                    ...
                    <p className="text-[10px] text-slate-500 uppercase mt-1">Version: 4.2.1-magic-fix</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 flex-grow overflow-hidden">
                <div className="flex flex-col space-y-6 overflow-y-auto pr-2">
                    ...
                    <section className="bg-slate-900 border border-slate-800 p-4 rounded-xl flex-grow shadow-inner">
                        <h2 className="text-amber-500 font-bold mb-4 uppercase text-xs tracking-widest">Active Session (Prop)</h2>
                        <pre className="text-[10px] text-slate-400 bg-black/40 p-3 rounded-lg overflow-x-auto border border-slate-800 scrollbar-thin scrollbar-thumb-slate-700">
